...
class StaticDropdownTextField<T> extends StatefulWidget {
  ...
  @override
  State<StaticDropdownTextField<T>> createState() =>
      _StaticDropdownTextFieldState<T>();
}

class _StaticDropdownTextFieldState<T> extends State<StaticDropdownTextField<T>>
